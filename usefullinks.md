...
3. [Merlin, the Neural Network based Speech Synthesis System](https://github.com/CSTR-Edinburgh/merlin)
4. [Mary TTS](http://mary.dfki.de/download/)
...
3. [How to code a simple RNN in Python](https://iamtrask.github.io//2015/11/15/anyone-can-code-lstm/)
4. [Sequence-to-Sequence G2P Toolkit](https://github.com/cmusphinx/g2p-seq2seq)
